...
Overall, we are optimistic that in the near future, we will be able to compute trustworthy reach-avoid sets for high-dimensional, real-world systems. Our hardware drone racing experiment is one example that suggests this goal is within reach. If you have any questions or suggestions to improve this work, please feel free to contact the correspondence author Jingqi Li at jingqili@berkeley.edu. Thank you!
